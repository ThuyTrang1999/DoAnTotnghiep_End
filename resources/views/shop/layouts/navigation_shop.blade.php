<div class="category-sub-menu">
    <ul>
        ...
        <li class="has-sub"><a>Thống Kê</a>
            <ul>
                <li><a href="{{route('thongke.danhthu')}}">Doanh Thu</a></li>
                <li><a href="{{route('shop.review')}}">Sản Phẩm bán chạy</a></li>
                <li><a href="{{route('shop.review')}}">Sản Phẩm được quan tâm</a></li>
            </ul>
        </li>
    </ul>
</div>