                        ...
                        <div class="product-details-view-content pt-60">
                            <div class="product-info">
                                ...
                                <div class="product-additional-info pt-25">
                                    <a class="wishlist-btn" href="wishlist.html"><i class="fa fa-heart"></i>Thêm vào
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="">
                ...
                <div class="modal-body">
                    <label for="email"><i class="fa fa-envelope"></i> Nhâp lại email</label>
                    <input class="mb-0 form-control" id="email" type="email" placeholder="email" name="email">
                </div>
