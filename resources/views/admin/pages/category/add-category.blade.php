...
<div class="row">
    <div class="col-md-12" style="margin: 0 auto;">
        <div class="x_panel">
            <div class="x_title">
                <h2>Thêm loại sản phẩm</small></h2>
            ...
            @csrf
                <div class="row">
                    <div class="form-group row col-md-6 col-sm-6">
                        ...
                        <div class="col-md-10 col-sm-10 ">
                            <input type="text" class="form-control" placeholder="Nhập tên loại " name="cate_name" @if(isset($category)) value ="{{ $category->cate_name}}" @endif>
                        </div>
                    </div>
                    <div class="form-group row col-md-6 col-sm-6">
                ...
                <div class="form-group">
                    <div class="col-md-12 col-sm-12 text-center">
                        <button type="submit" class="btn btn_submit">Thêm loại sản phẩm</button>
                    </div>
                </div>
            </form>
            </div>
