                ...
                <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action="{{route('product.xu-ly-them-moi')}}"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group row col-md-6 col-sm-6">
                                <label class="control-label col-md-2 col-sm-2 ">Hình sản phẩm</label>
                                <img id="buttonFile" 
                                    src="../../upload/avatar/icon_md.png"  alt="avt"
                                    style="height: 60px; width: 60px; cursor: pointer;">
                                    <input type="file" name="imgFile" id="file" @if(isset($listProduce))
                                    value="{{ $listProduce->listImg }}" @endif accept=".jpg, .png, .jpeg" accept="image/*"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group row col-md-6 col-sm-6 ">
                                ...
                                <div class="col-md-10 col-sm-10 ">
                                    <textarea id="" cols="10" name="shortdesc" rows="5" class="form-control"
                                        placeholder="..........."></textarea>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group row col-md-6 col-sm-6">
                                ...
                                <div class="col-md-10 col-sm-10 ">
                                    <input type="text" name="discout_price" class="form-control"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group row col-md-6 col-sm-6">
                                ...
                                <div class="col-md-10 col-sm-10 ">
                                    <input class="form-control-file" type="file" name="imgFile2[]" id="imgFile2" multiple>
                                </div>
