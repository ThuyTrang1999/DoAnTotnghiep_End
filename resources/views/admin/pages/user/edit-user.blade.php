                ...
                <form class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row col-md-6 col-sm-6">
                            ...
                            <div class="col-md-10 col-sm-10 ">
                                <img  @if(isset($addUser))
                                        src="../../upload/avatar/{{$addUser->avatar}}" @endif alt="avt" style="height: 70px; width: 70px;">
                                <input type="file" name="Hinh" id="Hinh" @if(isset($addUser)) value="{{ $addUser->avatar }}" @endif >
                            </div>
                        </div>
                        <!-- <div class="form-group row col-md-6 col-sm-6">
                    ...
                    <div class="row">
                        <div class="form-group row col-md-6 col-sm-6">
                            ...
                            <div class="col-md-10 col-sm-10">
                                <input  type="password" name="password" class="form-control password" placeholder="Nhập mật khẩu"@if(isset($addUser)) value="{{ $addUser->password }}" @endif >
                            </div>
                        </div>
                        <div class="form-group row col-md-6 col-sm-6 ">
                            <label class="control-label col-md-2 col-sm-2 ">Nhập Lại mật khẩu</label>
                            <div class="col-md-10 col-sm-10">
                                <input type="password" name="repassword" class="form-control password" placeholder="Nhập lại mật khẩu" @if(isset($addUser)) value="{{ $addUser->password }}" @endif >
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group row col-md-6 col-sm-6">
                            ...
                            <div class="col-md-10 col-sm-10">
                                ...
                                @if($addUser->role == 1){
                                        ...
                                        @else 
                                        <option selected value="2">Chủ shop</option>
